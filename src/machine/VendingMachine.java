...
import exceptions.InsertedMoneyIsLessThanItemPrice;
...
public class VendingMachine {
    ...
    public void selectItem(int shelfCode) throws InsertedMoneyIsLessThanItemPrice {
        if (inventory.canPurchaseItem(shelfCode,insertedMoney)){
            selectedShelfCode=shelfCode;
            stateContext.setState(new SelectionState());
        }
        else{
            throw new InsertedMoneyIsLessThanItemPrice("The money you inserted is less than product price please insert more money");
        }
    }
